...
typeInfer(scope::Scope, var::JVVariable) = begin
	if symbol(var) == :Array
...
typeInfer(scope::Scope, varRef::Ref{JVVariable}) = typeInfer(scope, varRef[])

struct LHS
	expr::Union{Ref{JVVariable}, JLExpr}
	newVar::Bool
end
...
mutable struct RHS
	expr::Union{Nothing, Ref{JVVariable}, Scalar, JLExpr}
end
