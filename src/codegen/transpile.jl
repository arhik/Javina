...
transpile(scope::Scope, var::JVVariable) = begin
...
transpile(scope::Scope, var::Ref{JVVariable}) = transpile(scope, var[])
...
function transpile(scope::Scope, a::AssignmentExpr)
	...
	elseif typeof(a.lhs.expr) == Base.RefValue{JVVariable}
...
function transpile(scope::Scope, atomicExpr::JVAtomics)
